...
class KalmanFilterPureNode(Node):
    def __init__(self):
        ...
        # Inicializamos el filtro con el estado inicial y la covarianza
        ...
        # Publicamos en el topic /kf_estimate
    ...
    def odom_callback(self, msg):
        ...
        # Creamos y rellenamos el mensaje que vamos a publicar en el topic /kf_estimate
